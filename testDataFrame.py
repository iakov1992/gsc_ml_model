...
def TestDataFrame(jet_type,etaLow,etaHigh,scale_target):
    folder_name = "jets"
    if jet_type == "LCTopo":
...
TestDataFrame(jet_type=opt.jet_type,etaLow = opt.etaLow,etaHigh=opt.etaHigh,scale_target=opt.scale_target)